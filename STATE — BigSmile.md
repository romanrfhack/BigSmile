...
[Hecho] El slice implementado actual de Release 7 es Release 7.1 — Documents Foundation y todavía no está aceptado.
...
[Hecho] Release 7 completa no está cerrada. Dashboard, OCR, rich preview, thumbnails, versionado, sharing externo, plantillas, PDFs generados, clasificación automática y workflows documentales avanzados siguen fuera del alcance implementado de Release 7.1.
