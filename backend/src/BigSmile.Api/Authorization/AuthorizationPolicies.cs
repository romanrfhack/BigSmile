...
namespace BigSmile.Api.Authorization
{
    public static class AuthorizationPolicies
    {
        ...
        public const string PatientIntakeAccessLinkManage = "patientportal.intake.manage";
        ...
        public static void AddPolicies(AuthorizationOptions options)
        {
            ...
            options.AddPolicy(PatientPortalInvitationManage, policy =>
            {
                policy.RequireAuthenticatedUser();
                policy.AddRequirements(new PermissionRequirement(
            ...
            options.AddPolicy(PatientIntakeAccessLinkManage, policy =>
            {
                policy.RequireAuthenticatedUser();
                policy.AddRequirements(new PermissionRequirement(
