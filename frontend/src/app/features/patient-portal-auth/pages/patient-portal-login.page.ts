...
@Component({
  selector: 'app-patient-portal-login-page',
  standalone: true,
  ...
  template: `
    <app-patient-portal-card
      ...
      description="Enter the private credentials created when your clinic activated your access.">
      ...
      <form class="patient-form" [formGroup]="form" (ngSubmit)="submit()" novalidate>
        ...
        <div class="patient-form__actions">
          <button
            ...
            {{ (facade.loading() ? 'Signing in...' : 'Sign in') | t }}
          </button>
        </div>
      </form>
    </app-patient-portal-card>
...
export class PatientPortalLoginPageComponent implements OnInit {
