...
export class TreatmentPlanStatusEditorComponent implements OnChanges {
  private readonly formBuilder = inject(FormBuilder);

  @Input() currentStatus: TreatmentPlanStatus = 'Draft';
  @Input() availableStatuses: TreatmentPlanStatus[] = ['Draft'];
  @Input() canWrite = false;
  @Input() saving = false;

  @Output() statusChanged = new EventEmitter<TreatmentPlanStatus>();
  ...
  submit(): void {
    ...
    this.statusChanged.emit(this.form.controls.status.value as TreatmentPlanStatus);
  }
}
