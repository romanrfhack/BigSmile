...
* **Phase 2 Expansion — Modern Operations:** open in progress through accepted slices **Phase 2.1 — Appointment Confirmation Foundation**, **Phase 2.2 — Manual Reminder Log Foundation**, **Phase 2.3 — Reminder Scheduling Preparation**, and **Phase 2.4 — Reminder Worklist Follow-up Actions**
* **Phase 2.5 — Reminder Template Draft Foundation:** implemented in repo, pending acceptance
...
* reviewing **Phase 2.5 — Reminder Template Draft Foundation** as implemented in repo but pending acceptance: tenant-owned internal text templates, create/list/update/deactivate, preview/render against existing appointments in tenant/branch scope, unknown placeholder reporting, UI management, and optional explicit use of rendered preview as manual follow-up note text only
...
* keeping WhatsApp/email/SMS sending, external providers, background jobs, queues, webhooks, external delivery templates, real scheduler workflows, retry automation, campaigns, online booking, patient portal, delivery status, and advanced notification automation outside the implemented Phase 2.5 scope
