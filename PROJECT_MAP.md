...
* keeping Release 3 explicitly open, not closed, while treating Release 3.1, Release 3.2, and Release 3.3 as the accepted slices so far
...
* keeping any full or advanced clinical timeline, any cross-module timeline, odontogram, treatments, and documents outside the accepted Release 3 slices
