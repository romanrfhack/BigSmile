...
* keeping WhatsApp/email/SMS sending, external providers, background jobs, queues, webhooks, external delivery templates, real scheduler workflows, retry automation, campaigns, online booking, patient portal, delivery status, and advanced notification automation outside the accepted Phase 2.5 scope
